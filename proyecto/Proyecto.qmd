...
ggplot(data = DF, aes(x = PERIODO)) +
  geom_bar(aes(y = CALLS_OUT_TOT, fill = "Llamadas Salientes"), position = "stack", stat = "identity") +
  geom_bar(aes(y = CALLS_IN_TOT, fill = "Llamadas Entrantes"), position = "stack", stat = "identity") +
