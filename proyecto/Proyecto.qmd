...
**Histograma de cantidad de días en los que recibieron llamadas :**
...
```{r}
print("Descriptores numéricos de los días en los que recibieron llamadas")
...
```{r}
hist(DF$DAYS_OUT_VOICE_TOT,breaks= 6, col = "lightblue", xlab = "Clientes", ylab = "Frecuencia", main = "Cantidad de dias en los que relizaron llamadas")
# Agregar la media y la mediana al histograma
abline(v = mean(DF$DAYS_IN_VOICE_TOT), col="blue")
abline(v = median(DF$DAYS_IN_VOICE_TOT), col="red")
