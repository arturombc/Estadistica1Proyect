...
Además podemos ver que la media y la mediana no estan tan alineadas, podemos declarar con cierta confianza que se debe a los `r dat_tot_atipicos` datos atípicos, aunque estos representen un `r (dat_tot_atipicos/nrow(DF$DATOS_TOTAL))*100`% de los datos
...
abline(v = mean(DF$DIAS_LLAMADAS_IN_TOT, na.rm =T), col="blue")
abline(v = median(DF$DIAS_LLAMADAS_IN_TOT, na.rm =T), col="red")
