...
La línea de tendencia (en color verde) trazada en el gráfico, nos muestra lo que mencionábamos anteriormente, que a medida que aumenta la cantidad de llamadas entrantes, el tiempo total de llamadas entrantes también tiende a aumentar en promedio.
Sin embargo, si nos enfocamos en cada usuario, representados por los puntos en el gráfico, vemos que algunos usuarios recibieron una cantidad considerable de llamadas con poco duración mientras que otros estuvieron más tiempo en una menor cantidad de llamadas. Esto demuestra que no siempre una mayor cantidad de llamadas entrantes se traduce en un mayor tiempo total de llamadas entrantes.
...
En este grafico se muestra que la mayoría de clientes Android, sin tac y IOS poseen un chip 4G. Mientras que la mayoría de clientes de otro sistema operativo poseen un chip 2G.
```{=html}
<script>
