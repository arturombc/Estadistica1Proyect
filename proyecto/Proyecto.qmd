...
Ya que en el gráfico anterior podemos ver las diferencias entre el consumo de datos por `CHIP`, podemos tomar de forma razonable a la variable `DATOS_4G` y analizarla.
