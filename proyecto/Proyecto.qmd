...
**Línea Diagonal:** Representa la relación cantidad y tiempo

**Punto en el gráfico:** Representa a cada usuario del servicio telefonico

**Diagonal:** Representa la línea de equipos que generan y convierten la misma cantidad de oportunidades claras de gol.

**Puntos sobre la diagonal:** Representa a los usuarios con una mayor cantidad de llamadas a comparación del tiempo total de llamadas recibidas, lo que indica aproximadamente una mayor duración de cada una de estas .

Puntos debajo de la diagonal: Representa a los usuarios con una menor cantidad de llamadas a comparación del tiempo total de llamadas recibidas, lo que indica aproximadamente una menor duración de cada una de estas.
