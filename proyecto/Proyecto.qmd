...
q3 <- quantile(DF$DATOS_TOTAL, 0.75)

# Calcular el primer cuartil (Q1)
q1 <- quantile(DF$DATOS_TOTAL, 0.25)
...
ylim_min <- 0
ylim_max <- round(q3 + 1.5 * iqr) + 1  # Redondear y agregar 1 para espacio en la parte superior

# Crear el gráfico de caja
ggplot(DF, aes(CHIP, DATOS_TOTAL / 100, fill = CHIP)) + 
