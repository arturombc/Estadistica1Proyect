...
Definimos un experimento $\epsilon_3$ determinado por $\{\Omega_3, \mathcal{F}_3, \mathbb{P}_3\}$ que consiste en elegir una persona de la muestra y anotar la cantidad de días que lo llamaron durante el mes.

Definimos la variable aleatoria $X_3$, buscaremos un modelo al que se distribuya correctamente.
